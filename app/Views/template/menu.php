    ...
    <div class="container">
        <ul class="nav page-navigation">
         ...
         <li class="nav-item">
                ...
                <div class="submenu">
                    <ul>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url('diagnosa')?>">Forward Chaining</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?=base_url('bcdiagnosa')?>">Backward Chaining</a>
                        </li>
                    </ul>
                </div>
            </li>
